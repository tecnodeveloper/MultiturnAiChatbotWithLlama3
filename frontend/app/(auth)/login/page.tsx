    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      <div className="w-full max-w-sm">
        ...
        <Button
          ...
          disabled={isSigningIn || isLoading}
          variant="outline"
          className="w-full h-12 bg-white hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 text-slate-900 border border-slate-300 font-medium rounded-lg flex items-center justify-center gap-2 transition-all duration-200"
        >
