  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      <div className="w-full max-sm:max-w-sm">
        ...
        <Button
          variant="outline"
          className="w-full h-12 bg-white hover:bg-gray-100 text-black border border-gray-300 font-medium rounded-lg mb-6 transition-colors"
        ...
        <Button
          ...
          disabled={isSigningUp || isLoading}
          variant="outline"
          className="w-full h-12 bg-white hover:bg-gray-50 text-black border border-gray-300 font-medium rounded-lg flex items-center justify-center gap-2 transition-colors"
        >
